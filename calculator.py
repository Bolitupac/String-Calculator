...
dirty_input = input("Prompt(words only eg five plus three, type END to end): \n")


#now ill clean the input and split the words and put them in the clean input
clean_input = dirty_input.lower().split()

#loop to run the program until end command is detected
while not "END" in clean_input:
